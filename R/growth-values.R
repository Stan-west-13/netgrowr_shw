...
#' acquisition.
#'
#' @seealso \code{\link[netgrowr]{preferential_attachment}}, \code{\link[netgrowr]{lure_of_the_associates}}, \code{\link[netgrowr]{preferential_acquisition}}, \code{\link[netgrowr]{opsahl_weighted_degree}}
#'
#' @references
